...
export default function PrivacyPolicy() {
  return (
    <div className="prose max-w-4xl mx-auto p-6 bg-white shadow rounded">
      ...
      <h2>7. Contact</h2>
      <p>
        For questions or requests, either use the contact form or email us at: <a href="mailto:long131005@gmail.com">long131005@gmail.com</a>
      </p>
    </div>
  );
}